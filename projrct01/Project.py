...
button1 = Button(black, 220, 720, 150, 75,Button1_image, 'Normal Attack')
...
while run:
    ...
    #คำเตื่อนต้องการ MP
    Watting_MP = font.render("Requires 20 MP to use the skill.", True, (red))
    Watting_AP = font.render("Requires 6 AP to use the skill.", True, (red))
    if WattingMP == True:
        screen.blit(Watting_MP,(650,300))
    if WattingAP == True:
        screen.blit(Watting_AP,(650,300))
